...
class TextInputItem extends StatefulWidget {
   TextInputItem({super.key, required this.question, required this.index, this.isCreated, });
                    ...
                    children: [
                      Padding(
                        ...
                        child: TextField(decoration: InputDecoration(
                          ...
                          var updated = widget.question.copyWith(singleAnswer: widget.isCreated ?null : answerController.text,title: titleController.text);
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              var updated = widget.question.copyWith(singleAnswer:answerController.text,title: titleController.text);
                               c.updateTextQuestion(updated,widget.index);
                              },
