...
class TextInputItemPreview extends StatefulWidget {
  const TextInputItemPreview({super.key, required this.question, required this.index, });
  final Question question;
  final int index;


  @override
  State<TextInputItemPreview> createState() => _TextInputItemPreviewState();
}

class _TextInputItemPreviewState extends State<TextInputItemPreview> {
